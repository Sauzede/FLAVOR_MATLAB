...
temporaire=fopen('FLAVOR_PSC_weight_17x9x5x3.sn','r');
fgetl(temporaire);
...
Moy=load('Mean_Training_FLAVOR_PSC.dat');
Ecart=load('Std_Training_FLAVOR_PSC.dat');

%%% DATA is the user's input file

%data=load('validation_dataset_psc.dat');
...
save MICRO_mlp.dat Estimated_MICRO -ascii
save NANO_mlp.dat Estimated_NANO -ascii
save PICO_mlp.dat Estimated_PICO -ascii
